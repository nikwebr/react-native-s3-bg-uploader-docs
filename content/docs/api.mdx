...
<auto-type-table path="../../lib/s3-bg-uploader.types.ts" name="NativeS3BgUploaderAPI" />

## WebS3BgUploaderAPI
<auto-type-table path="../../lib/s3-bg-uploader.types.ts" name="WebS3BgUploaderAPI" />

## UploadProgress
<auto-type-table path="../../lib/s3-bg-uploader.types.ts" name="UploadProgress" />

## AggregateProgress
<auto-type-table path="../../lib/s3-bg-uploader.types.ts" name="AggregateProgress" />
...
<auto-type-table path="../../lib/s3-bg-uploader.types.ts" name="S3BgUploaderResumeError" />
...
<auto-type-table path="../../lib/s3-bg-uploader.types.ts" name="S3BgUploaderDuplicateFileError" />